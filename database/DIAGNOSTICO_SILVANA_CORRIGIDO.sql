-- DIAGNÓSTICO COMPLETO - Silvana Admin (CORRIGIDO)
...
-- 4. Ver colaboradores com nome Silvana (SEM campo email)
SELECT 'COLABORADORES SILVANA' as tipo, id, nome, cpf FROM colaboradores 
