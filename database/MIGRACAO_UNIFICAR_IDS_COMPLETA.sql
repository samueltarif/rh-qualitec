...
-- =====================================================
-- Versão 2.0 - Trata TODAS as foreign keys automaticamente
-- =====================================================
...
-- =====================================================
-- PASSO 5: Descobrir TODAS as foreign keys
-- =====================================================
SELECT 
  '📋 FOREIGN KEYS ENCONTRADAS:' as info,
  tc.table_name,
  kcu.column_name,
  tc.constraint_name
...
-- =====================================================
-- PASSO 6: Remover TODAS as constraints CASCADE
-- =====================================================
ALTER TABLE colaboradores DROP CONSTRAINT IF EXISTS colaboradores_pkey CASCADE;

-- =====================================================
-- PASSO 7: Adicionar colunas UUID temporárias em TODAS as tabelas
-- =====================================================

-- Tabelas já tratadas no script anterior
...
-- =====================================================
-- PASSO 8: Migrar dados para as novas colunas UUID
-- =====================================================
...
-- =====================================================
-- PASSO 9: Remover coluna id antiga de colaboradores
-- =====================================================
ALTER TABLE colaboradores DROP COLUMN IF EXISTS id;
ALTER TABLE colaboradores DROP COLUMN IF EXISTS gestor_id;

-- =====================================================
-- PASSO 10: Renomear new_id para id em colaboradores
-- =====================================================
ALTER TABLE colaboradores RENAME COLUMN new_id TO id;
ALTER TABLE colaboradores RENAME COLUMN new_gestor_id TO gestor_id;

-- =====================================================
-- PASSO 11: Definir novo id como PRIMARY KEY
-- =====================================================
ALTER TABLE colaboradores ADD PRIMARY KEY (id);

-- =====================================================
-- PASSO 12: Atualizar TODAS as tabelas relacionadas
-- =====================================================
...
ALTER TABLE ferias DROP COLUMN IF EXISTS aprovador_colaborador_id;
