...
-- Sistema de solicitações e documentos para funcionários
...
CREATE INDEX IF NOT EXISTS idx_solicitacoes_func_data ON solicitacoes_funcionario(data_solicitacao DESC);
...
CREATE TABLE IF NOT EXISTS documentos_funcionario (
  ...
  titulo VARCHAR(200) NOT NULL,
  descricao TEXT,
  competencia VARCHAR(7), -- YYYY-MM para holerites
  ano_referencia INTEGER, -- Para informe de rendimentos
  arquivo_url TEXT,
...
CREATE INDEX IF NOT EXISTS idx_docs_func_competencia ON documentos_funcionario(competencia);

-- ============================================================================
-- 3. TABELA DE REGISTRO DE PONTO DO FUNCIONÁRIO
-- ============================================================================
...
CREATE INDEX IF NOT EXISTS idx_ponto_colaborador_data ON registros_ponto(colaborador_id, data);
...
CREATE INDEX IF NOT EXISTS idx_banco_horas_data ON banco_horas(data DESC);

-- ============================================================================
-- 5. TABELA DE COMUNICADOS PARA FUNCIONÁRIOS
-- ============================================================================
...
-- 9. COMENTÁRIOS
-- ============================================================================
COMMENT ON TABLE solicitacoes_funcionario IS 'Solicitações feitas pelos funcionários (férias, documentos, etc)';
COMMENT ON TABLE documentos_funcionario IS 'Documentos disponíveis para funcionários (holerites, informes, etc)';
COMMENT ON TABLE registros_ponto IS 'Registros de ponto dos funcionários';
COMMENT ON TABLE banco_horas IS 'Controle de banco de horas';
COMMENT ON TABLE comunicados IS 'Comunicados da empresa para funcionários';
COMMENT ON TABLE comunicados_lidos IS 'Registro de leitura de comunicados';
