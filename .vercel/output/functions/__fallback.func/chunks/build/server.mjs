import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { c as createError$1, y as hasProtocol, z as isScriptProtocol, A as joinURL, w as withQuery, B as sanitizeStatusCode, C as getContext, $ as $fetch, D as createHooks, E as executeAsync, f as getHeader, F as toRouteMatcher, G as createRouter$1, H as defu, s as setCookie } from '../_/nitro.mjs';
...
const _routes = [
  ...
  },
  {
    ...
    meta: { "middleware": ["auth", "admin"] },
    component: () => import('./funcionarios-BsFAvsGE.mjs')
  },
  {
    name: "admin-departamentos",
    path: "/admin/departamentos",
    meta: { "middleware": ["auth", "admin"] },
    component: () => import('./departamentos-P56WcoSp.mjs')
  }
];
...
const layouts = {
  default: vueExports.defineAsyncComponent(() => import('./default-BkCi9lIN.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vueExports.defineAsyncComponent(() => import('./error-404-eKQ-7dIt.mjs'));
    const _Error = vueExports.defineAsyncComponent(() => import('./error-500-WVnta9-Y.mjs'));
