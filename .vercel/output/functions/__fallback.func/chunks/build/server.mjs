...
import { c as createError$1, v as hasProtocol, x as isScriptProtocol, y as joinURL, w as withQuery, z as sanitizeStatusCode, A as getContext, $ as $fetch, B as createHooks, C as executeAsync, f as getHeader, D as toRouteMatcher, E as createRouter$1, F as defu, s as setCookie } from '../_/nitro.mjs';
...
const _routes = [
  ...
  },
  {
    ...
    component: () => import('./dashboard-DKV1c8Mi.mjs')
  },
  {
    name: "holerites",
    path: "/holerites",
    meta: { "middleware": "auth" },
    component: () => import('./holerites-DqVVOUJI.mjs')
  },
  {
    name: "meus-dados",
    path: "/meus-dados",
    meta: { "middleware": "auth" },
    component: () => import('./meus-dados-BAeqZj7T.mjs')
  },
  {
    name: "admin-cargos",
    path: "/admin/cargos",
  ...
  },
  {
    ...
    meta: { "middleware": ["auth", "admin"] },
    component: () => import('./funcionarios-Bnv-XZEL.mjs')
  },
  {
    name: "admin-departamentos",
    path: "/admin/departamentos",
    meta: { "middleware": ["auth", "admin"] },
    component: () => import('./departamentos-BvKR9XtL.mjs')
  }
];
