/**
 * Script para corrigir os totais dos holerites que estão com cálculos incorretos
 * 
 * Problema identificado: Quando o adiantamento é editado no formulário,
 * os campos total_descontos e salario_liquido não são recalculados.
 */
    ...
    for (const holerite of holerites) {
      try {
        ...
        if (precisaCorrigir) {
          ...
          console.log(`   Funcionário: ${holerite.funcionario?.nome_completo || 'N/A'}`)
...
export { corrigirTotaisHolerites }